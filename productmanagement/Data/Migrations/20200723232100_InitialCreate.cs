    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                 ...
                 columns: table => new
                 {
                     Invoice_Detail_Number = table.Column<int>(nullable: false)
                 ...
                 constraints: table =>
                 {
                     table.PrimaryKey("PK_Invoice_Details", x => x.Invoice_Detail_Number);
                 });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Client_Invoice = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    Sub_Total_Invoice = table.Column<float>(type: "float", nullable: false),
                    Total_Invoice = table.Column<float>(type: "float", nullable: false)
                },
                constraints: table =>
                {
